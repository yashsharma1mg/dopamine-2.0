...
The sheet is content-driven between **128px (min)** and **600px (max)**; the `height` prop pins it
to a fixed height (clamped to that range) — the Storybook variants show the min and max heights.
